def send_sms_bomb():
    ...
    def Wolf(xak, delay=0.001):  # delay set to 0.001 seconds
        for x in xak:
            sys.stdout.write(x)
            sys.stdout.flush()
            time.sleep(delay)
    ...
    info = f'''{y}  Please contact with admin to get a license key 
...
# Now you can call the function to execute the code
send_sms_bomb()
